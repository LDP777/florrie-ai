...
The first version was held locally during the 7 September incident check. The 8 September release incorporates it into the Libraries.dev brief redesign; see 2026-09-08-libraries-brief.md and the deployment handoff for current release evidence.
...
- This does not establish the state of Ellie’s iPhone. That check did not establish the iPhone state.
