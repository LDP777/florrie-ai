...
const s = {
  ...
  chip:         { padding: '7px 12px', borderRadius: 10, border: '1.5px solid var(--border, #E8DDD4)', background: 'transparent', fontSize: 13, fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit', color: 'var(--text-primary, #241B17)' },
  ...
  saveBtn:      { flex: 1, padding: '12px 0', borderRadius: 10, border: 'none', background: 'var(--accent, #92405e)', color: '#fff', fontSize: 14, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit' },
  cancelBtn:    { padding: '12px 20px', borderRadius: 10, border: '1.5px solid var(--border, #E8DDD4)', background: 'transparent', color: 'var(--text-muted, #6B5D54)', fontSize: 14, cursor: 'pointer', fontFamily: 'inherit' },
  ...
  linkBox:      { flex: 1, background: 'var(--bg, #FBF6F1)', border: '1px solid var(--border, #E8DDD4)', borderRadius: 10, padding: '8px 10px', overflow: 'hidden' },
  ...
  copyBtn:      { padding: '8px 14px', borderRadius: 10, border: 'none', color: '#fff', fontSize: 12, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit', whiteSpace: 'nowrap', transition: 'background 0.2s' },

  courseActions:{ display: 'flex', gap: 8, paddingTop: 10, borderTop: '1px solid var(--border, #E8DDD4)' },
  actionBtn:    { flex: 1, padding: '8px 10px', borderRadius: 10, border: '1px solid var(--border, #E8DDD4)', background: 'transparent', color: 'var(--accent, #92405e)', fontSize: 12, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit' },
