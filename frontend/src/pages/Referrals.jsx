...
const s = {
  ...
  leaderBar: { width: 40, height: 6, borderRadius: 6, background: 'var(--border, #E8DDD4)', overflow: 'hidden', flexShrink: 0 },
  leaderFill: { height: '100%', borderRadius: 6, background: 'var(--accent, #92405e)' },
