...
const S = {
  ...
  wlCard: { background: 'var(--bg-card, #FFFCF9)', borderRadius: 16, padding: 14, cursor: 'pointer', borderLeft: '3px solid var(--border, #E8DDD4)' },
  ...
  priBadge: { display: 'inline-flex', alignItems: 'center', gap: 3, padding: '2px 8px', borderRadius: 'var(--radius-xs)', fontSize: 10, fontWeight: 600 },
  priIcon: { fontSize: 12 },
  ...
  dayTag: { padding: '2px 6px', borderRadius: 'var(--radius-xs)', background: 'var(--border, #E8DDD4)', color: 'var(--text-secondary, #574A42)', fontSize: 11 },
  ...
  actionBtn: { flex: 1, padding: '9px 0', borderRadius: 10, border: '1px solid var(--border, #E8DDD4)', background: 'var(--bg-card, #FFFCF9)', fontSize: 12, fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit', color: 'var(--text-primary, #241B17)' },
  ...
  dayChip: { width: 40, height: 36, borderRadius: 10, border: '1px solid var(--border, #E8DDD4)', background: 'var(--bg-card, #FFFCF9)', fontSize: 12, fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit', color: 'var(--text-secondary, #574A42)', display: 'flex', alignItems: 'center', justifyContent: 'center' },
