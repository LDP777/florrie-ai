    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          why: 'Choose whether clients pay a deposit when booking. Connect card payments below to collect it.',
          path: '/settings?section=policy',
          done: !!svc.deposits,
          optional: true,
        },
      ],
      ...
      items: [
        {
          ...
          why: 'Check the requirements and connect Instagram, WhatsApp or SMS from channel settings.',
      ...
      items: [
        {
          ...
          why: 'Choose the questions and consent your clients need to complete before treatment.',
        ...
        },
        {
          ...
          why: 'Clients can complete the required form from their manage-booking link when their preparation steps allow it.',
          path: '/treatments',
        ...
        },
        {
          ...
          why: 'Connect Stripe to accept card payments and booking deposits.',
          path: '/settings?section=payments',
          done: !!money.stripe,
          optional: true,
        },
      ],
