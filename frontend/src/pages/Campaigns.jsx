...
const TYPE_CONFIG = {
  reactivation: { label: 'Comeback', icon: '💌', color: '#C76B8A', desc: 'Win back clients who haven\'t visited in a while' },
  rescue: { label: 'Rescue', icon: '🆘', color: '#E57373', desc: 'Save a cancellation with a quick rebook offer' },
  weather: { label: 'Weather', icon: '🌧️', color: '#4A90D9', desc: 'Bad weather = pamper day. Triggered by forecast' },
  bank_holiday: { label: 'Bank Holiday', icon: '🎉', color: '#F5A623', desc: 'Promo blast before long weekends' },
  event: { label: 'Seasonal', icon: '🎄', color: '#4CAF50', desc: 'Christmas, Valentine\'s, Mother\'s Day specials' },
  custom: { label: 'Custom', icon: '✏️', color: '#8A8580', desc: 'Write your own campaign from scratch' },
};

const STATUS_LABELS = {
  draft: { label: 'Draft', color: '#F5A623', bg: '#FFF8E1' },
  approved: { label: 'Ready', color: '#4A90D9', bg: '#EEF4FC' },
  sending: { label: 'Sending', color: '#C76B8A', bg: '#FBF0F3' },
  sent: { label: 'Sent', color: '#4CAF50', bg: '#E8F5E9' },
  cancelled: { label: 'Cancelled', color: '#AAA5A0', bg: '#F5F2EF' },
};
      ...
      <div style={styles.tabs}>
        {[
          ...
          <button
            ...
            style={{
              ...styles.tab,
              borderBottomColor: tab === t.key || (tab === 'create' && t.key === 'active') ? '#C76B8A' : 'transparent',
              color: tab === t.key || (tab === 'create' && t.key === 'active') ? '#C76B8A' : '#AAA5A0',
            }}
          >
            {t.label}
          </button>
...
const styles = {
  ...
  typeCard: {
    ...
    padding: '14px 8px', borderRadius: 12, background: '#fff',
    boxShadow: '0 1px 3px rgba(0,0,0,0.04)', border: 'none',
    cursor: 'pointer', fontFamily: 'inherit',
  },
  typeLabel: { fontSize: 11, fontWeight: 600, color: '#5A5550' },

  // AI suggestion
  aiCard: { background: 'linear-gradient(135deg, #FBF0F3 0%, #F5EFFC 100%)', borderRadius: 14, padding: 16 },
  aiCardHeader: { display: 'flex', gap: 8, alignItems: 'center', marginBottom: 8 },
  aiCardTitle: { fontSize: 13, fontWeight: 600, color: '#2D2A26' },
  aiCardText: { fontSize: 13, color: '#5A5550', margin: '0 0 12px', lineHeight: 1.5 },
  aiCardBtn: {
  ...
  campaignName: { display: 'block', fontSize: 14, fontWeight: 600, color: '#2D2A26' },
  campaignMeta: { display: 'block', fontSize: 11, color: '#AAA5A0', marginTop: 2 },
  campaignPreview: { fontSize: 13, color: '#8A8580', margin: '0 0 10px', lineHeight: 1.5 },
  miniStats: { display: 'flex', gap: 12, paddingTop: 8, borderTop: '1px solid #F5F2EF' },
  miniStat: { fontSize: 12, color: '#8A8580' },
  cardActions: { display: 'flex', gap: 8, paddingTop: 10, borderTop: '1px solid #F5F2EF' },
  approveBtn: {
  ...
  cancelCardBtn: {
    ...
    background: '#F5F2EF', color: '#AAA5A0', fontSize: 13,
    cursor: 'pointer', fontFamily: 'inherit',
  },
  ...
  typeHeader: {
    ...
    borderLeft: '4px solid #C76B8A',
    boxShadow: '0 1px 3px rgba(0,0,0,0.04)',
  },
  typeHeaderLabel: { display: 'block', fontSize: 15, fontWeight: 600, color: '#2D2A26' },
  typeHeaderDesc: { display: 'block', fontSize: 12, color: '#8A8580', marginTop: 2 },
  nameInput: {
  ...
  fieldLabel: { fontSize: 12, fontWeight: 600, color: '#AAA5A0', textTransform: 'uppercase', letterSpacing: '0.04em' },
  msgTextarea: {
  ...
  shuffleBtn: {
    ...
    border: '1.5px solid #E0DBD5', background: 'transparent',
    color: '#8A8580', fontSize: 12, fontWeight: 500,
    cursor: 'pointer', fontFamily: 'inherit',
  },
  targetCard: {
    display: 'flex', gap: 12, alignItems: 'center',
  ...
  targetLabel: { display: 'block', fontSize: 13, fontWeight: 600, color: '#2D2A26' },
  targetHint: { display: 'block', fontSize: 11, color: '#AAA5A0', marginTop: 2 },
  createActions: { display: 'flex', gap: 8, marginTop: 4 },
  primaryBtn: {
    flex: 1, padding: '14px 0', borderRadius: 12, border: 'none',
    background: '#C76B8A', color: '#fff', fontSize: 15, fontWeight: 600,
    cursor: 'pointer', fontFamily: 'inherit',
  },
  cancelBtn: {
    padding: '14px 20px', borderRadius: 12, border: 'none',
    background: '#F5F2EF', color: '#8A8580', fontSize: 15,
    cursor: 'pointer', fontFamily: 'inherit',
  },
  ...
  detailPanel: {
    background: '#FAF8F5', borderRadius: '20px 20px 0 0', width: '100%',
  ...
  detailName: { fontSize: 18, fontWeight: 700, margin: '8px 0', color: '#2D2A26' },
  detailMsgCard: { background: '#fff', borderRadius: 12, padding: 14, marginBottom: 12, boxShadow: '0 1px 3px rgba(0,0,0,0.04)' },
  detailMsgLabel: { display: 'block', fontSize: 10, fontWeight: 600, color: '#AAA5A0', textTransform: 'uppercase', letterSpacing: '0.04em', marginBottom: 6 },
  detailMsgText: { fontSize: 13, color: '#5A5550', margin: 0, lineHeight: 1.6, whiteSpace: 'pre-wrap' },
  perfGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: 8, marginBottom: 12 },
  perfStatBox: { background: '#fff', borderRadius: 10, padding: '10px 6px', textAlign: 'center', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' },
  perfStatValue: { display: 'block', fontSize: 18, fontWeight: 700 },
  perfStatLabel: { display: 'block', fontSize: 9, color: '#AAA5A0', textTransform: 'uppercase', marginTop: 2 },
  revenueRecovered: {
  ...
  detailMetaText: { display: 'block', fontSize: 11, color: '#C4BDB6' },

  // Empty states
  emptyHint: { textAlign: 'center', padding: '20px 16px' },
  emptyText: { fontSize: 13, color: '#AAA5A0', margin: 0, lineHeight: 1.5 },
