          ...
          <div style={styles.detailPanel} onClick={e => e.stopPropagation()}>
            ...
            {sendResult.error ? (
              <div style={styles.resultHeader}>
                <span style={{ fontSize: 30 }}>{<Icon name="alert-triangle" inline />}</span>
...
const styles = {
  page: { minHeight: 'var(--shell-viewport)', background: 'var(--bg, #FBF6F1)', fontFamily: "'Plus Jakarta Sans', -apple-system, sans-serif", padding: '0 16px var(--scroll-pad-bottom)', maxWidth: 480, margin: '0 auto', color: 'var(--text, #241B17)' },
  ...
  typeCard: {
    ...
    padding: '14px 8px', borderRadius: 10, background: 'var(--bg-card, #FFFCF9)',
    boxShadow: 'var(--elev-1)', border: 'none',
    cursor: 'pointer', fontFamily: 'inherit',
  },
  typeLabel: { fontSize: 11, fontWeight: 600, color: 'var(--text-secondary, #574A42)' },

  // AI suggestion
  aiCard: { background: 'linear-gradient(135deg, var(--accent-light, #F6E7EC) 0%, #F5EFFC 100%)', borderRadius: 16, padding: 16 },
  ...
  typeHeader: {
    ...
    padding: 14, borderRadius: 10, background: 'var(--bg-card, #FFFCF9)',
  ...
  detailMsgCard: { background: 'var(--bg-card, #FFFCF9)', borderRadius: 10, padding: 14, marginBottom: 12, boxShadow: 'var(--elev-1)' },
  ...
  perfStatBox: { background: 'var(--bg-card, #FFFCF9)', borderRadius: 10, padding: '10px 6px', textAlign: 'center', boxShadow: 'var(--elev-1)' },
