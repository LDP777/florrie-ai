...
const S = {
  ...
  periodActive: { background: 'var(--accent)', color: 'var(--on-accent, #fff)', border: '1px solid var(--accent)' },
  ...
  reasonTag: { padding: '3px 8px', borderRadius: 'var(--radius-xs)', background: 'var(--bg-hover, var(--bg-subtle, #ede7e3))', color: 'var(--text-secondary, #574A42)', fontSize: 11, fontStyle: 'italic' },
  lostTag: { padding: '3px 8px', borderRadius: 'var(--radius-xs)', background: 'var(--danger-bg, #F7E4E4)', color: 'var(--danger, #9E2B32)', fontSize: 11, fontWeight: 600 },
  depositTag: { padding: '3px 8px', borderRadius: 'var(--radius-xs)', background: 'var(--success-bg, #E9F0EB)', color: 'var(--success, #386F52)', fontSize: 11, fontWeight: 500 },
  noticeTag: { padding: '3px 8px', borderRadius: 'var(--radius-xs)', background: 'var(--border, var(--border, #E8DDD4))', color: 'var(--text-secondary, #574A42)', fontSize: 11 },
  rebookedTag: { padding: '3px 8px', borderRadius: 'var(--radius-xs)', background: 'var(--success-bg, #E9F0EB)', color: 'var(--success, #386F52)', fontSize: 11, fontWeight: 600 },
  rebookBtn: { padding: '3px 10px', borderRadius: 'var(--radius-xs)', background: 'var(--accent, #92405e)', color: 'var(--bg-card, #FFFCF9)', border: 'none', fontSize: 11, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit' },
  ...
  dayBarBg: { flex: 1, height: 8, borderRadius: 'var(--radius-xs)', background: 'var(--border, var(--border, #E8DDD4))' },
  dayBarFill: { height: 8, borderRadius: 'var(--radius-xs)', background: 'var(--accent, #92405e)' },
