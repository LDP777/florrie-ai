...
const endpoints = [
  ...
  { method: 'GET',   path: '/api/sms/config',               description: 'Get Bird SMS configuration and status', auth: true },
  { method: 'PUT',   path: '/api/sms/config',               description: 'Update SMS sender name and preferences', auth: true },
  { method: 'POST',  path: '/api/sms/test',                 description: 'Send a test SMS to verify Bird connection', auth: true },
