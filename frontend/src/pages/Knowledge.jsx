...
const S = {
  ...
  intro: {
    fontSize: 13.5,
    color: 'var(--text-secondary, #534247)',
    lineHeight: 1.5,
    margin: '0 0 16px',
  },
  quietNote: {
    ...
    fontSize: 13, color: 'var(--text-secondary, #534247)',
    marginBottom: 16,
  },
  errorNote: {
  ...
  formHeading: { fontSize: 14, fontWeight: 700, color: 'var(--text-primary, #1d1b19)' },
  label: {
    display: 'block', fontSize: 10, fontWeight: 700, color: '#B5AFA8',
  ...
  select: {
    ...
    background: 'var(--bg, #fef8f4)', fontSize: 14,
    fontFamily: 'inherit', color: 'var(--text-primary, #1d1b19)',
  ...
  emptyText: {
    fontSize: 13.5, color: 'var(--text-secondary, #534247)',
  ...
  starterButton: {
    ...
    background: 'var(--bg, #fef8f4)', cursor: 'pointer',
    fontFamily: 'inherit',
    WebkitTapHighlightColor: 'transparent',
  },
  starterTitle: { fontSize: 13, fontWeight: 700, color: 'var(--text-primary, #1d1b19)' },
  starterHint: { fontSize: 11.5, color: 'var(--text-muted, #9B8A8E)', marginTop: 2 },
  sectionLabel: {
