    ...
    <div style={styles.page}>
      ...
      <div style={styles.heroCard}>
        ...
        <div style={styles.heroBreakdown}>
          <span>{'\uD83D\uDCB3'} <Money amount={d.cardTaken} /></span>
          <span>{'\uD83D\uDCB5'} <Money amount={d.cashTaken} /></span>
          {d.voucherRedeemed > 0 && <span>{'\uD83C\uDF81'} <Money amount={d.voucherRedeemed} /></span>}
        </div>
              ...
              <div style={styles.statsGrid}>
                ...
                {d.totalRevenue > 0 && (
                  <div style={{ ...styles.statCard, gridColumn: '1 / -1' }}>
                    <div style={styles.statIcon}>{'\uD83D\uDCB0'}</div>
                    <div style={styles.statValue}><Money amount={(d.totalRevenue - d.expenses + d.tipsReceived)} /></div>
                ...
                <div key={i} style={styles.timelineRow}>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    {appt.status === 'completed' && (
                      <>
                        <div style={styles.timelineAmount}><Money amount={appt.amount} /></div>
            ...
            <div style={styles.section}>
              ...
              <div style={styles.cashupCard}>
                <div style={styles.cashupRow}>
                  ...
                  <span style={{ fontSize: 16, fontWeight: 600 }}><Money amount={d.cashTaken} /></span>
                </div>
                ...
                <div style={styles.cashupRow}>
                  ...
                  <span style={{ fontSize: 14, fontWeight: 500 }}><Money amount={d.cardTaken} /></span>
                </div>
                <div style={styles.cashupRow}>
                  <span style={{ fontSize: 14, color: 'var(--text-secondary, #574A42)' }}>Tips collected</span>
                  <span style={{ fontSize: 14, fontWeight: 500 }}><Money amount={d.tipsReceived} /></span>
                </div>
              </div>
...
const styles = {
  ...
  tabs: { display: 'flex', gap: 4, marginBottom: 16, background: 'var(--bg-hover, #f3ede9)', borderRadius: 10, padding: 4 },
  ...
  statCard: { background: 'var(--bg-card, #FFFCF9)', borderRadius: 10, padding: 14, border: '1px solid var(--border-light, #ede7e3)' },
  ...
  reconBtn: { width: '100%', padding: '14px 0', borderRadius: 10, border: 'none', color: 'var(--bg-card, #FFFCF9)', fontSize: 15, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit' },
