          ...
          {(mode === 'csv' ? ['Upload', 'Map', 'Preview', 'Import'] : ['Paste', 'Preview', 'Import']).map((s, i) => {
            ...
            return (
              <div key={s} style={styles.stepItem}>
                <div style={{
                  ...styles.stepDot,
                  background: i <= stepIndex ? '#C76B8A' : '#E0DBD5',
                }} />
                <span style={{
                  ...styles.stepLabel,
                  color: i <= stepIndex ? '#C76B8A' : '#AAA5A0',
                }}>{s}</span>
              </div>
            );
          })}
...
const styles = {
  ...
  modeLabel: { fontSize: 16, fontWeight: 600, color: '#2D2A26' },
  modeDesc: { fontSize: 12, color: '#8A8580', textAlign: 'center', lineHeight: 1.4 },

  steps: { display: 'flex', justifyContent: 'center', gap: 24, marginBottom: 16, paddingBottom: 12, borderBottom: '1px solid #F0ECE8' },
  ...
  dropText: { fontSize: 14, fontWeight: 600, color: '#2D2A26' },
  dropHint: { fontSize: 11, color: '#AAA5A0', textAlign: 'center' },
  ...
  mapHeader: { fontSize: 13, fontWeight: 600, color: '#2D2A26' },
  mapSelect: { padding: '6px 10px', borderRadius: 8, border: '1.5px solid #F0ECE8', fontSize: 12, fontFamily: 'inherit', background: '#fff', color: '#2D2A26' },
  ...
  exampleLabel: { fontSize: 10, fontWeight: 600, color: '#AAA5A0', textTransform: 'uppercase', letterSpacing: '0.04em' },
  exampleText: { fontSize: 12, color: '#8A8580', fontFamily: 'monospace' },
  manualTextarea: { width: '100%', padding: 14, borderRadius: 12, border: '1.5px solid #F0ECE8', fontSize: 14, fontFamily: 'inherit', resize: 'vertical', outline: 'none', lineHeight: 1.6, boxSizing: 'border-box' },
  ...
  previewRow: { display: 'flex', alignItems: 'center', gap: 10, padding: '8px 0', borderBottom: '1px solid #F5F2EF' },
  previewAvatar: { width: 30, height: 30, borderRadius: 15, background: '#FBF0F3', color: '#C76B8A', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 700, flexShrink: 0 },
  previewName: { display: 'block', fontSize: 13, fontWeight: 600, color: '#2D2A26' },
  previewMeta: { display: 'block', fontSize: 11, color: '#AAA5A0' },
  previewMore: { textAlign: 'center', fontSize: 12, color: '#C76B8A', padding: 8, margin: 0 },
  ...
  progressBarTrack: { height: 6, borderRadius: 3, background: '#F5F2EF', overflow: 'hidden' },
  progressBarFill: { height: '100%', borderRadius: 3, background: '#C76B8A', transition: 'width 0.3s ease' },
  progressPct: { display: 'block', fontSize: 12, color: '#AAA5A0', marginTop: 8 },
  ...
  primaryBtn: { flex: 1, padding: '14px 0', borderRadius: 12, border: 'none', background: '#C76B8A', color: '#fff', fontSize: 15, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit' },
  backBtn: { padding: '14px 20px', borderRadius: 12, border: 'none', background: '#F5F2EF', color: '#8A8580', fontSize: 15, cursor: 'pointer', fontFamily: 'inherit' },
};
