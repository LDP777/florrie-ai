...
const S = {
  ...
  clientAvatar: { width: 26, height: 26, borderRadius: 16, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 600, flexShrink: 0 },
  profileCard: { background: 'var(--card, #FFFCF9)', borderRadius: 16, padding: 16, marginBottom: 16 },
  ...
  tag: { padding: '2px 8px', borderRadius: 'var(--radius-xs)', background: 'var(--accent-light, #F6E7EC)', color: 'var(--accent, #92405e)', fontSize: 10, fontWeight: 600 },
  ...
  addNoteCard: { background: 'var(--card, #FFFCF9)', borderRadius: 16, padding: 14, marginBottom: 12 },
  ...
  noteCancelBtn: { padding: '8px 16px', borderRadius: 10, border: '1px solid var(--border, #E8DDD4)', background: 'transparent', fontSize: 12, fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit', color: 'var(--text-secondary, #574A42)' },
  noteSaveBtn: { padding: '8px 16px', borderRadius: 10, border: 'none', background: 'var(--accent, #92405e)', color: '#fff', fontSize: 12, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit' },
  timeline: {},
  ...
  dot: { width: 8, height: 8, borderRadius: 'var(--radius-xs)', flexShrink: 0 },
  ...
  eventStatus: { display: 'inline-block', padding: '2px 8px', borderRadius: 'var(--radius-xs)', fontSize: 10, fontWeight: 600, marginTop: 6, textTransform: 'capitalize' },
  channelTag: { display: 'inline-block', padding: '2px 8px', borderRadius: 'var(--radius-xs)', background: '#E3F2FD', color: 'var(--info, #2E6DA4)', fontSize: 10, fontWeight: 500, marginTop: 6 },
