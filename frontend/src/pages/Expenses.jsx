...
const S = {
  ...
  summaryCard: { flex: 1, background: 'var(--card, #FFFCF9)', borderRadius: 10, padding: '12px 8px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2 },
  ...
  card: { background: 'var(--card, #FFFCF9)', borderRadius: 16, padding: 16, marginBottom: 12 },
  ...
  catIcon: { width: 32, height: 32, borderRadius: 10, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16, flexShrink: 0 },
  ...
  exportBtn: { width: '100%', padding: '12px 0', borderRadius: 10, border: '1px solid var(--border, var(--border, #E8DDD4))', background: 'var(--card, #FFFCF9)', fontSize: 14, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit', color: 'var(--text-primary, #241B17)', marginTop: 4 },

  // List
  list: { display: 'flex', flexDirection: 'column', gap: 8 },
  expenseCard: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'var(--card, #FFFCF9)', borderRadius: 10, padding: 12 },
  ...
  tagTax: { fontSize: 10, color: '#6B8F7B', padding: '2px 6px', borderRadius: 6, background: 'var(--success-bg, #E9F0EB)' },
  ...
  budgetCard: { background: 'var(--card, #FFFCF9)', borderRadius: 10, padding: 14 },
  ...
  catChip: { padding: '6px 10px', borderRadius: 10, border: '1px solid var(--border, var(--border, #E8DDD4))', background: 'var(--card, #FFFCF9)', fontSize: 12, cursor: 'pointer', fontFamily: 'inherit', color: 'var(--text-primary, #241B17)' },
  ...
  toggleDot: { width: 22, height: 22, borderRadius: 10, background: '#fff', position: 'absolute', top: 2, transition: 'transform 0.2s', boxShadow: 'var(--elev-1)' },
  intervalRow: { display: 'flex', gap: 8, marginTop: 8 },
  intervalChip: { flex: 1, padding: '8px 0', borderRadius: 10, border: '1px solid var(--border, var(--border, #E8DDD4))', background: 'var(--bg-card, #FFFCF9)', fontSize: 12, fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit', color: 'var(--text-primary, #241B17)', textTransform: 'capitalize' },
