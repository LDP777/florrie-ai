...
const STATUS_CFG = {
  ok: { label: 'In Stock', bg: '#E8F5E9', color: '#4CAF50' },
  low: { label: 'Low Stock', bg: '#FFF5E6', color: '#FF9800' },
  out: { label: 'Out of Stock', bg: '#FFEBEE', color: '#F44336' },
};
              ...
              {isExp && (
                <div style={S.expandedSection}>
                  <div style={S.detailGrid}>
                    ...
                    {prod.retailPrice && (
                      <div style={S.detailItem}>
                        ...
                        <span style={{ ...S.detailValue, color: '#C76B8A' }}>{fmt(prod.retailPrice)}</span>
                      </div>
                    )}
                    {prod.retailPrice && (
                      <div style={S.detailItem}>
                        <span style={S.detailLabel}>Margin</span>
                        <span style={{ ...S.detailValue, color: '#4CAF50' }}>{Math.round(((prod.retailPrice - prod.costPer) / prod.retailPrice) * 100)}%</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div style={S.actionRow}>
                    <button style={{ ...S.actionBtn, background: '#C76B8A', color: '#fff' }}>Restock</button>
...
const S = {
  ...
  summaryNum: { fontSize: 18, fontWeight: 700, color: '#C76B8A' },
  ...
  filterChip: { padding: '7px 14px', borderRadius: 20, border: '1px solid #F0ECE8', background: 'var(--card, #fff)', fontSize: 12, fontWeight: 600, color: '#AAA5A0', cursor: 'pointer', fontFamily: 'inherit', whiteSpace: 'nowrap' },
  ...
  sortLabel: { fontSize: 12, color: '#AAA5A0', fontWeight: 600 },
  sortBtn: { padding: '5px 12px', borderRadius: 8, border: '1px solid #F0ECE8', background: 'var(--card, #fff)', fontSize: 11, fontWeight: 600, color: '#AAA5A0', cursor: 'pointer', fontFamily: 'inherit' },
  ...
  cardName: { fontSize: 14, fontWeight: 600, color: 'var(--text, #2D2A26)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  ...
  stockTrack: { height: 6, borderRadius: 3, background: '#F0ECE8', overflow: 'hidden' },
  ...
  catBtn: { padding: '7px 14px', borderRadius: 8, border: '1px solid #F0ECE8', background: 'var(--card, #fff)', fontSize: 12, fontWeight: 600, color: '#AAA5A0', cursor: 'pointer', fontFamily: 'inherit' },
