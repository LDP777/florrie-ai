...
const S = {
  ...
  emptyState: { textAlign: 'center', padding: '40px 20px', background: 'var(--card, #FFFCF9)', borderRadius: 16 },
  ...
  addonCard: { background: 'var(--card, #FFFCF9)', borderRadius: 16, padding: 14, cursor: 'pointer', transition: 'opacity 0.2s' },
  addonHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  addonLeft: { display: 'flex', gap: 10, alignItems: 'center' },
  catDot: { width: 10, height: 10, borderRadius: 'var(--radius-xs)', flexShrink: 0 },
  ...
  autoTag: { padding: '2px 6px', borderRadius: 'var(--radius-xs)', background: 'var(--success-bg, #E9F0EB)', color: 'var(--success, #386F52)', fontSize: 10, fontWeight: 600 },
  ...
  treatmentTag: { padding: '3px 8px', borderRadius: 'var(--radius-xs)', background: 'var(--accent-light, #F6E7EC)', color: 'var(--accent, #92405e)', fontSize: 11 },
  actionRow: { display: 'flex', gap: 8 },
  actionBtn: { flex: 1, padding: '9px 0', borderRadius: 10, border: '1px solid var(--border, #E8DDD4)', background: 'var(--card, #FFFCF9)', fontSize: 12, fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit', color: 'var(--text, #241B17)' },

  // Performance
  perfContainer: { display: 'flex', flexDirection: 'column', gap: 12 },
  card: { background: 'var(--card, #FFFCF9)', borderRadius: 16, padding: 16 },
  ...
  rankBarBg: { height: 6, borderRadius: 'var(--radius-xs)', background: 'var(--border, #E8DDD4)' },
  rankBarFill: { height: 6, borderRadius: 'var(--radius-xs)' },
  ...
  errorBanner: { background: 'var(--danger-bg, #F7E4E4)', color: 'var(--accent, #92405e)', padding: '8px 12px', borderRadius: 10, fontSize: 13, marginBottom: 12 },
  ...
  treatmentPickChip: { padding: '5px 10px', borderRadius: 10, border: '1px solid var(--border, #E8DDD4)', background: 'var(--bg-card, #FFFCF9)', fontSize: 11, cursor: 'pointer', fontFamily: 'inherit', color: 'var(--text-secondary, #574A42)' },
  ...
  saveBtn: { width: '100%', padding: '14px 0', borderRadius: 10, border: 'none', background: 'var(--accent, #92405e)', color: '#fff', fontSize: 15, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit', marginTop: 20, transition: 'opacity 0.2s' },
};
