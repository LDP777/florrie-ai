...
const S = {
  ...
  catDot: { width: 10, height: 10, borderRadius: 6, flexShrink: 0 },
  ...
  rankBarBg: { height: 6, borderRadius: 6, background: 'var(--border, #E8DDD4)' },
  rankBarFill: { height: 6, borderRadius: 6 },
